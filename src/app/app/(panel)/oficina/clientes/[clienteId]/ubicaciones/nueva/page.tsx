  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-5 py-10 sm:px-8 sm:py-14">
      <nav className="mb-6 text-sm text-forest-950/50">
        ...
        <span className="mx-2">/</span>
        <span className="text-forest-950">Nueva ubicación</span>
      </nav>
      ...
      <header className="mb-8">
        ...
        <p className="mt-2 text-sm text-forest-950/60">
          Una propiedad donde se presta el servicio. Puede ser una plaza, un edificio, un fraccionamiento.
        </p>
      </header>

      <FormularioDeUbicacion clienteId={clienteId} />
    </div>
  );
}
